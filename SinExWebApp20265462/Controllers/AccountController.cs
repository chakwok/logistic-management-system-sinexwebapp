...
namespace SinExWebApp20265462.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            var result = db.ShippingAccounts.Where(u => u.UserName.ToLower() == userName.ToLower()).Count() == 0;
